...
const LoginModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full sm:w-[800px] h-full sm:h-[480px] max-w-full max-h-full overflow-hidden relative flex flex-col sm:flex-row">
        {/* Close button */}
        <button
          onClick={onClose}
